...
declare namespace egret {
    ...
    class EventDispatcher extends HashObject implements IEventDispatcher {
        ...
        ae(type: string, listener: Function, thisObject: any, useCapture?: boolean, priority?: number): void;
        aett(listener: Function, thisObject: any, useCapture?: boolean, priority?: number): void;
        aec(listener: Function, thisObject: any, useCapture?: boolean, priority?: number): void;
        /**
         * @inheritDoc
         * @version Egret 2.4
         * @platform Web,Native
...
declare namespace egret {
    ...
    class DisplayObject extends EventDispatcher {
        ...
        readonly pa: DisplayObjectContainer;
        /**
         * @private
         * 设置父级显示对象
         */
         ...
         * @private
         * add by chenyingpeng
         * true when texture premulti alpha
         */
...
declare namespace egret {
    ...
    class DisplayObjectContainer extends DisplayObject {
        ...
        ac(child: DisplayObject): DisplayObject;
        /**
        ...
        rc(child: DisplayObject): DisplayObject;
        /**
...
declare namespace egret {
    ...
    class BitmapData extends HashObject {
        ...
        private static _disposeResKeys;
        private static _resKeyLastAddTicks;
        static getDisposeResKeys(): {
            [key: string]: boolean;
        };
        static clearDisposeResKeys(): void;
        static removeDisposeResKey(resKey: string): void;
        static getResKeyLastAddTick(resKey: string): number;
    }
}
declare namespace egret {
...
declare namespace egret {
    ...
    class HtmlTextParser {
        ...
        private addFaceToResultArr(style);
...
declare namespace egret {
    ...
    class TextField extends DisplayObject {
        ...
        private static _face_textures;
        private static _face_anims;
        /**
         * @version Egret 2.4
         * @platform Web,Native
         */
         ...
         *
         */
        private fillBackground(lines?, faces?);
        static regFaceTexture(key: string, texture: egret.Texture): void;
        static getFaceTexture(key: string): egret.Texture;
        static regFaceAnim(key: string, frm_cnt: number): void;
        static isFaceAnim(key: string): boolean;
        static getFaceAnimFrmCnt(key: string): number;
        private static genFaceAnimKey(key, index);
        private _face_anim_idx;
        private _is_play_face_anim;
        private _start_face_anim_time;
        private _last_face_anim_time;
        private _face_anim_frm_rate;
        setFaceAnimFrmRate(frm_rate: number): void;
        setIsPlayFaceAnim(value: boolean): void;
        private static readonly ADVANCD_FACE_ANIM_INTERVAL;
        private advanceFaceAnimTime(time_stamp);
        /**
