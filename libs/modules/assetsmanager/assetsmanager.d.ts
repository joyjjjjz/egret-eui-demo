...
declare module RES {
    ...
    */
     ...
     * @language zh_CN
     */
    function getResByUrl(url: string, compFunc?: Function, thisObject?: any, type?: string, priority?: number): Promise<any>;
    /**
    ...
    */
    ...
    class Resource extends egret.EventDispatcher {
         ...
         * @param type {string}
         */
        getResByUrl(url: string, compFunc?: Function, thisObject?: any, type?: string, priority?: number): Promise<any>;
        /**
         * 销毁单个资源文件或一组资源的缓存数据,返回是否删除成功。
...
declare module RES {
    ...
    function profileToStr(): void;
    function profileTexture(): void;
    /**
    * @private
    */
